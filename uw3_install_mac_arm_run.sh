...
install_petsc(){
		...
		echo "export PETSC_ARCH=arch-darwin-c-opt" >> ~/.bash_profile
		source ~/.bash_profile
...
install_underworld3(){
		...
		#cd $UW3_DEV                 \
		$GIT_COMMAND ${INSTALL_PATH}/uw3_run \
		&& cd $INSTALL_PATH/uw3_run \
		&& ./clean.sh               \
